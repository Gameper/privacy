...
**1. 회원가입 및 상품 구매 등 필요 시점에 수집하는 개인정보 항목**
...
| 판매회원 상품등록 | 사업자 확인        | 사업자등록증 사본, 사업자명의 통장 사본                                                                     |
|                   | 스토어 생성        | JPG, JPEG, PNG, GIF 형식의 파일                                                                             |
| 추가인증          | 사업자 휴대폰 인증 | 사업자등록증 사본, 휴대폰명의 확인 서류                                                                     |
|                   | 휴대폰번호 초기화  | 신분증 사본, 통신사 이용계약증명서(또는 입금 사실 증명서류)                                                 |
|                   | 개명               | 신분증 사본, 개명증명서(초본 등)                                                                            |
|                   | 카카오 계정 연결   | 카카오 계정(이메일)                                                                                         |
| 포인트 서비스     | 포인트 인출        | 은행명, 계좌번호(사업자는 서류 제출 필요), 사업자등록증 사본, 통장 사본                                     |
...
- 직책 : 개인정보 보호 책임자
- 이메일 : cs@talket.io
- 문의 : 고객센터 카카오톡 채널 @톡켓\_talket_nft
- 담당부서 : 정보보안팀
